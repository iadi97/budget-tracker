...
export default function SavingsTable({ monthId }: Props) {
  const { rows, loading, addRow, updateRow, deleteRow } = useSavings(monthId);
              ...
              <tr key={r.id} className="border-b">
                <td className="p-2">
                  <input
                    ...
                    value={r.goal_name}
                    onChange={(e) => updateRow(r.id, "goal_name", e.target.value)}
                  />
                </td>
